<template>
  <div class="example-2 card">
      <div class="wrapper">
        <div class="date">
          <v-avatar>
            <v-img src="https://aceship.github.io/AN-EN-Tags/img/factions/logo_rhodes.png"></v-img>
          </v-avatar>
          <span class="day">&copy; HyperGryph - Rhodes Island</span>
        </div>
        
        <div class="data">
          <div class="content">
            <span class="author">Alert</span>
            <h1 class="title">
...
.example-2 .wrapper {
  background: url(https://cdn.wiki.denfaminicogamer.jp/files/attachment/000/347/636/full_upload.jpg)
